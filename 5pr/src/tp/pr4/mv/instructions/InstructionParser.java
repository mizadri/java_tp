...
import tp.pr4.mv.instructions.arithmetics.*;
import tp.pr4.mv.instructions.booleanCond.*;
import tp.pr4.mv.instructions.jumps.*;
import tp.pr4.mv.instructions.numericCond.*;
import tp.pr4.mv.instructions.restSeq.*;
...
public class InstructionParser {
	...
	public Instruction parseProgramInstruction(String line) throws WrongInstructionFormatException {
		...
		if(ins == null) throw new WrongInstructionFormatException("Error en el formato de la instruccion:" + line);
		return ins;
