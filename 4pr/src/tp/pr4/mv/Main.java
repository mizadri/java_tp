...
public class Main {
	...
	public static void exeBatch(){
			...
			try{
				...
				System.err.println( e.getMessage() + ": " + cpu.getCurrentInstruction().toString());
				sc.close(); 
				CPU.getInStrat().close(); 
				CPU.getOutStrat().close();
				System.exit(2);
				...
				System.err.println( e.getMessage() + "Ejecutando " + cpu.getCurrentInstruction());
				sc.close(); 
				CPU.getInStrat().close(); 
				CPU.getOutStrat().close();
				System.exit(2);
	...
	public static void exeWindow(){
		MainWindow mwindow = new MainWindow(cpu);
	}
